...
htmlhelp_basename = 'diffusionsdoc'
...
latex_documents = [
  ('index', 'diffusions.tex', 'diffusions Documentation',
...
man_pages = [
    ('index', 'diffusions', 'diffusions Documentation',
     ['Stanislav Khrapov'], 1)
]
...
texinfo_documents = [
  ('index', 'diffusions', 'diffusions Documentation',
   'Stanislav Khrapov', 'diffusions', 'One line description of project.',
   'Miscellaneous'),
]
